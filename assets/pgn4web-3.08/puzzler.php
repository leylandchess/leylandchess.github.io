...
$lightColorHex = get_param("lightColorHex", "lch", "EFF4EC", "/^[0123456789ABCDEF]{6}$/i");
$lightColorHexCss = "#" . $lightColorHex;
$darkColorHex = get_param("darkColorHex", "dch", "C6CEC3", "/^[0123456789ABCDEF]{6}$/i");
$darkColorHexCss = "#" . $darkColorHex;

$controlBackgroundColorHex = get_param("controlBackgroundColorHex", "cbch", "EFF4EC", "/^[0123456789ABCDEF]{6}$/i");
$controlBackgroundColorHexCss = "#" . $controlBackgroundColorHex;
$controlTextColorHex = get_param("controlTextColorHex", "ctch", "888888", "/^[0123456789ABCDEF]{6}$/i");
$controlTextColorHexCss = "#" . $controlTextColorHex;


$squareSize = get_param("squareSize", "ss", "30", "/^\d+$/");
...
$pieceFont = get_param("pieceFont", "pf", "default", "/^[0-9a-z]+$/i");
...
$frameBorderColorHex = get_param("frameBorderColorHex", "fbch", "C6CEC3", "/^([0123456789ABCDEF]{6}|none)$/i");
...
$backgroundColorHex = get_param("backgroundColorHex", "bch", "transparent", "/^([0123456789ABCDEF]{6}|transparent)$/i");
...
$framePadding = get_param("framePadding", "fp", 0, "/^\d+$/");
if ($framePadding != 0) {
